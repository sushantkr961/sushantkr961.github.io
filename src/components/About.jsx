      ...
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="mt-5 w-[90%] sm:grid sm:grid-cols-2 lg:flex justify-between">
          <div className="flex flex-col items-center justify-center p-1 m-1">
            <p className="border-[8px] rounded-[50%] p-10 w-16 h-16 flex justify-center items-center text-xl font-medium m-3 border-[#ff4500]">
              1000+
            </p>
            <p className="text-lg font-bold">Hours of Coding</p>
          </div>
          <div className="flex flex-col items-center justify-center p-1 m-1">
            <p className="border-[8px] rounded-[50%] p-10 w-16 h-16 flex justify-center items-center text-xl font-medium m-3 border-[#d1bea8]">
              400+
            </p>
            <p className="text-lg font-bold">Hours of DSA</p>
          </div>
          <div className="flex flex-col items-center justify-center p-1 m-1">
            <p className="border-[8px] rounded-[50%] p-10 w-16 h-16 flex justify-center items-center text-xl font-medium m-3 border-[#008000]">
              5+
            </p>
            <p className="text-lg font-bold">Projects Done</p>
          </div>
          <div className="flex flex-col items-center justify-center p-1 m-1">
            <p className="border-[8px] rounded-[50%] p-10 w-16 h-16 flex justify-center items-center text-xl font-medium m-3 border-[#483d8b]">
              100+
            </p>
